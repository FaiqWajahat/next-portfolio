                ...
                <div className="flex flex-col ">
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            whileHover="hover"
                            className="group border-b border-white/10 py-12 md:py-16 grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-12 relative overflow-hidden"
                        >
                            ...
                            <div className="md:col-span-2 text-primary font-bold text-2xl md:text-4xl tracking-tighter pt-2">
                                {service.id}
                            </div>

                            <div className="md:col-span-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                                <h3 className="text-4xl md:text-5xl font-black tracking-tight text-white group-hover:text-primary transition-colors duration-300 md:w-1/2">
                                    {service.title}
                                </h3>

                                <p className="text-xl text-neutral-400 leading-relaxed md:w-1/2 font-medium group-hover:text-neutral-300 transition-colors duration-300">
                                    {service.description}
                                </p>
                            </div>
                        </motion.div>
