...
export default function Footer() {
    ...
    return (
        <footer id="contact" className="w-full bg-neutral-950 pt-32 pb-12 border-t border-white/10 relative overflow-hidden flex flex-col items-center justify-center">
            ...
            {/* Copyright row */}
            <div className="container mx-auto px-6 max-w-7xl mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-3 z-10 text-center md:text-left">
